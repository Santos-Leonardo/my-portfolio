...
const Social = () => {
    ...
    return (
        <ul className={styles.socialBox}>
            <li className={styles.socialIcon} title='LinkedIn'><a href="https://www.linkedin.com/in/leonardo-santos-dev/" target='_blank' title='linkedin.com/in/leonardo-santos-dev'><img src={linkein} alt="LinkedIn" /></a></li>
            <li className={styles.socialIcon} title='GitHub'><a href="https://github.com/Santos-Leonardo" target='_blank' title='github.com/Santos-Leonardo'><img src={github} alt="GitHub" /></a></li>
